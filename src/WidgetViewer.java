...
/*
 * As an alternative positioning of the button or field,
 * this will just add the button or field in the next 
 * "default positioning" spot.
 * 
 */
		add(jcomp);

/*
 * And now back to our regular processing...
 */
		lock.lock();
		try {
			while (!userClicked) {
